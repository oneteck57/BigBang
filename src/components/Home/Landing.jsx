    ...
    <>
      <div className="landing h-[140vh] bg-[#2F2F2F] relative overflow-hidden flex flex-col items-center justify-center text-center text-white">
        ...
        <img
          ...
          alt="brain yoga"
          className="absolute bottom-[25rem] left-40 select-none"
          draggable="false"
          style={{
            width: "140px",
            height: "auto",
        ...
        <div className="relative z-20 mt-24 flex flex-col items-center">
          <h1 className="text-8xl font-bold mb-4">THE BIG BANG</h1>
          <button className="bg-[#F3EDD3] border-2 border-black text-black px-6 py-2 rounded-full mb-4 font-semibold hover:bg-yellow-600 transition-colors">
            Get your Tickets
          </button>
          <p className="text-lg font-medium italic mt-10">
